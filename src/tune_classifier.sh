...
python simple_predictor.py -c ../data/predictor_results/epc-map_test/epc-map_test_length  -p ../data/predictor_results/epc-map_test/epc-map/ -m asd  -s ../data/predictor_results/epc-map_test/psipred/
