    ...
    for n in g.nodes(data=True):
        ...
        if True:
            for o in g.nodes(data=True):
                if o[0] != n[0]:
                    sec_2_lower = sec_struct[o[1]['xl'][0]]
                    sec_2_upper = sec_struct[o[1]['xl'][1]]

                    sec_struct_shift_dict  = shift_dict[(sec_lower, sec_upper, sec_2_lower, sec_2_upper)]
...
def main():
    ...
    shift_dict = cPickle.load(open("probabilities/shifts_test_double.p", "rb"))
