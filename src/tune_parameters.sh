...
time python tune_pagerank_parameters.py -c ../data/predictor_results/epc-map_test/epc-map_test_length -p /scratch/schneider/projects/pagerank_refinement/data/predictor_results/epc-map_test/epc-map/ -s /scratch/schneider/projects/pagerank_refinement/data/predictor_results/epc-map_test/psipred/ -m epc-map
