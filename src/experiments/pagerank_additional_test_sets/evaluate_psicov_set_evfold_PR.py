...
def main():
    ...
    for pdb_id, length in protein_data:
        ...
        contact_file= "".join(["/scratch/schneider/projects/pagerank_refinement/results/pagerank_refinement/psicov_set/evfold/",
                             pdb_id,
                             "_RRPAR_0.4_2.0__0"])

        dom_ass = "1-%s" % length
        
        evaluate_contact_file(pdb_file, pdb_id, contact_file, length, dom_ass, "/scratch/schneider/projects/pagerank_refinement/src/experiments/pagerank_additional_test_sets/psicov_evfold_new_PR.txt")
