...
python ../evaluate_PR.py -t /scratch/schneider/projects/pagerank_refinement/results/pagerank_auto_eval/d329/epc-map/ -a 0.35 -b 2.5 -p /scratch/schneider/projects/pagerank_refinement/data/predictor_results/d329/ -o /scratch/schneider/projects/pagerank_refinement/results/pagerank_auto_eval/d329_epc-map_PR.txt -l /scratch/schneider/projects/pagerank_refinement/data/predictor_results/d329/d329_lengths
