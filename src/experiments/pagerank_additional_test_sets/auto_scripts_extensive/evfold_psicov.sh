...
python ../compute_pagerank.py -t /scratch/schneider/projects/pagerank_refinement/data/predictor_results/psicov/evfold/ -a 0.8 -b 3.0 -l /scratch/schneider/projects/pagerank_refinement/data/predictor_results/psicov/psicov_lengths -s /scratch/schneider/projects/pagerank_refinement/data/predictor_results/psicov/psipred/ -o /scratch/schneider/projects/pagerank_refinement/results/pagerank_auto_eval/psicov/evfold/
python ../evaluate_PR.py -t /scratch/schneider/projects/pagerank_refinement/results/pagerank_auto_eval/psicov/evfold/ -a 0.8 -b 3.0 -p /scratch/schneider/projects/pagerank_refinement/data/predictor_results/psicov/ -o /scratch/schneider/projects/pagerank_refinement/results/pagerank_auto_eval/psicov_evfold_PR.txt -l /scratch/schneider/projects/pagerank_refinement/data/predictor_results/psicov/psicov_lengths
