...
python ../compute_pagerank.py -t /scratch/schneider/projects/pagerank_refinement/data/predictor_results/metapsicov_test/epc-map/ -a 0.475 -b 2.9 -l /scratch/schneider/projects/pagerank_refinement/data/predictor_results/metapsicov_test/metapsicov_test_lengths -s /scratch/schneider/projects/pagerank_refinement/data/predictor_results/metapsicov_test/psipred/ -o /scratch/schneider/projects/pagerank_refinement/results/pagerank_auto_eval/metapsicov_test/epc-map/
python ../evaluate_PR.py -t /scratch/schneider/projects/pagerank_refinement/results/pagerank_auto_eval/metapsicov_test/epc-map/ -a 0.475 -b 2.9 -p /scratch/schneider/projects/pagerank_refinement/data/predictor_results/metapsicov_test/ -o /scratch/schneider/projects/pagerank_refinement/results/pagerank_auto_eval/metapsicov_test_epc-map_PR.txt -l /scratch/schneider/projects/pagerank_refinement/data/predictor_results/metapsicov_test/metapsicov_test_lengths
