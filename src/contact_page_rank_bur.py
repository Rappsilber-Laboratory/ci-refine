...
def build_ce_graph(xl_data, length, shift_dict, sec_struct, bur_types):
    ...
    for n in g.nodes(data=True):
        ...
        bur_lower = bur_types[n[1]['xl'][0]]
        bur_upper = bur_types[n[1]['xl'][1]]

        sec_struct_shift_dict = shift_dict[(sec_lower, sec_upper, bur_lower, bur_upper)]
