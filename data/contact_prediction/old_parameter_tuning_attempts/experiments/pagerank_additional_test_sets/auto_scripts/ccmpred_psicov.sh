...
python ../compute_pagerank.py -t /scratch/schneider/projects/pagerank_refinement/data/predictor_results/psicov/ccmpred/ -a 0.45 -b 2.0 -l /scratch/schneider/projects/pagerank_refinement/data/predictor_results/psicov/psicov_lengths -s /scratch/schneider/projects/pagerank_refinement/data/predictor_results/psicov/psipred/ -o /scratch/schneider/projects/pagerank_refinement/results/pagerank_auto_eval/psicov/ccmpred/
python ../evaluate_PR.py -t /scratch/schneider/projects/pagerank_refinement/results/pagerank_auto_eval/psicov/ccmpred/ -a 0.45 -b 2.0 -p /scratch/schneider/projects/pagerank_refinement/data/predictor_results/psicov/ -o /scratch/schneider/projects/pagerank_refinement/results/pagerank_auto_eval/psicov_ccmpred_PR.txt -l /scratch/schneider/projects/pagerank_refinement/data/predictor_results/psicov/psicov_lengths
